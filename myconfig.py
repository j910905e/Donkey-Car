...
THROTTLE_STOPPED_PWM = 309      #pwm value for no movement
THROTTLE_REVERSE_PWM = 277      #pwm value for max reverse throttle
# 
...
JOYSTICK_MAX_THROTTLE = 0.63        #this scalar is multiplied with the -1 to 1 throttle value to limit the maximum throttle. This can help if you drop the controller or just don't need the full speed available.
